...
LOCKREWARDCONDITION_JSON_PATH = os.path.join(BUILD_DIR, 'LockRewardCondition.json')
print(LOCKREWARDCONDITION_JSON_PATH)
if not (os.path.exists(LOCKREWARDCONDITION_JSON_PATH)):
