...
TEMPLATE_STORE_MANAGER_JSON_PATH = os.path.join(BUILD_DIR, 'TemplateStoreManager.json')

if not (os.path.exists(TEMPLATE_STORE_MANAGER_JSON_PATH)):
...
if __name__ == '__main__':
    ...
    from creation           import create_template_store_manager
    ...
    contract_account = create_template_store_manager(m, owner_account, TEMPLATE_STORE_MANAGER_JSON_PATH)
