...
HASHLOCKCONDITION_JSON_PATH = os.path.join(BUILD_DIR, 'HashLockCondition.json')
print(HASHLOCKCONDITION_JSON_PATH)
if not (os.path.exists(HASHLOCKCONDITION_JSON_PATH)):
